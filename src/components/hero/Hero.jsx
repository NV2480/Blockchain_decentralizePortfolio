...
import heroImg from '../../assets/skills/ImagePhoto.png'
import './Hero.css'
    ...
    return (
        ...
        <div className="container">
            <div className="hero-text">
                <p><span style={{ fontSize: 'larger' }}>Neha Verma </span>
                Blockchain Enthusiast | Web 3.0 | Java Developer </p>
                <p>From India</p>
                <h1>Eager to explore the world of decentralized apps in the web3 space.</h1>
                <h3>{description}</h3>
                {/*  =========popup bootstrap==========  */}
